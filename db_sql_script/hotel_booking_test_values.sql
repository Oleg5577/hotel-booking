...
INSERT INTO `hotel_booking_db`.`room_type` (`type_name`) VALUES ('standart');
...
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-07-22', '2017-07-24', 2, 'in_progress', 3, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-07-25', '2017-07-28', 1, 'confirmed', 4, 2);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-07-24', '2017-07-27', 1, 'confirmed', 5, 4);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-07-21', '2017-08-01', 2, 'denied', 6, 3);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-07-26', '2017-07-29', 2, 'confirmed', 7, 2);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-07-24', '2017-07-28', 2, 'confirmed', 8, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-08-02', '2017-08-06', 1, 'confirmed', 9, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-08-06', '2017-08-11', 2, 'in_progress', 3, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-08-10', '2017-08-15', 2, 'in_progress', 4, 2);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `user_id`, `room_type_id`) VALUES ('2017-08-12', '2017-09-14', 2, 'in_progress', 5, 3);

INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-06-12', '2017-06-15', 120, 3, 1, TRUE, 'checked-out');
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-07-13', '2017-07-16', 120, 4, 1, TRUE, 'checked-out');
...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-06-15', '2017-06-18', 180, 5, 4, TRUE, 'checked-out');
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-06-22', '2017-06-23', 120, 3, 5, TRUE, 'checked-out');
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-06-23', '2017-06-28', 300, 2, 6, FALSE, 'checked-in');
...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-06-28', '2017-06-30', 160, 8, 8, FALSE, 'checked-in');
...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-07-11', '2017-07-14', 600, 10, 10, FALSE, 'checked-out');
