...
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-09-22', '2017-09-24', 2, 'in_progress', 3, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-09-25', '2017-09-28', 1, 'in_progress', 4, 2);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-09-24', '2017-09-27', 2, 'in_progress', 5, 4);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-09-21', '2017-10-01', 2, 'denied', 6, 3);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-09-26', '2017-09-29', 2, 'in_progress', 7, 2);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-09-24', '2017-09-28', 2, 'in_progress', 8, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-10-02', '2017-10-06', 1, 'confirmed', 9, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-10-06', '2017-10-11', 2, 'in_progress', 3, 1);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-10-10', '2017-10-15', 2, 'in_progress', 4, 2);
INSERT INTO `hotel_booking_db`.`room_request` (`check_in`, `check_out`, `room_size`, `request_status`, `fk_user_id`, `fk_room_type_id`) VALUES ('2017-10-12', '2017-10-14', 2, 'in_progress', 5, 3);
...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-09-07', '2017-09-08', 40, 2, 4, FALSE, 'expect_guest_arrival');
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`) VALUES ('2017-09-13', '2017-09-15', 100, 4, 3, FALSE);
...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-09-05', '2017-09-07', 120, 5, 5, FALSE, 'checked_in');
...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-09-05', '2017-09-10', 300, 2, 6, TRUE, 'checked_in');
...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-06-28', '2017-06-30', 160, 8, 8, TRUE, 'checked_out');
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-09-10', '2017-09-15', 400, 3, 9, FALSE, 'expect_guest_arrival');
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-07-11', '2017-07-14', 600, 10, 10, TRUE, 'checked_out');
