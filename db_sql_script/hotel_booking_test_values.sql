...
INSERT INTO `hotel_booking_db`.`order` (`check_in`, `check_out`, `amount`, `fk_room_id`, `fk_user_id`, `is_paid`, `order_status`) VALUES ('2017-07-01', '2017-07-05', 400, 3, 9, FALSE, 'expect_guest_arrival');
